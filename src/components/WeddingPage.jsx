      ...
      <main className="bg-gray-100">
        ...
        <section id="historia" className="relative h-screen">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-end justify-start p-16">
                <h2 className="text-white text-6xl font-bold animate-appear-grow font-dancingscript flex flex-col items-start">
                <span>Nuestra</span><span className='ps-4'>Historia de</span><span className='ps-8 font-updock text-8xl font-semibold'>Amor</span>
                </h2>
            </div>
        </section>
        ...
        <div className="container mx-auto px-6 text-center flex justify-between">
            ...
            <div className='w-3/5 px-8 text-left flex flex-col justify-center'>
                <h3 className="text-2xl mb-4 font-dancingscript">Felices para</h3>
